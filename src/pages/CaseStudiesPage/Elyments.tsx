...
const Elyments = () => {
    ...
    const idData = [
        {
            ...
            mainheading: "Income",
            subheading: "The reach of Whatsapp goes beyond the rich, with the following figures:  ",
            lastText: "Today every person owns a smartphone and it is no more a luxury for anyone. Even if all the people of the country have a smartphone, still not all of them will be able to use WhatsApp because it is only available in English and not everyone has a strong hold on the English language.   ",
        },
        {
            imagePath: `${AgeIcon}`,
            mainheading: "Age group  ",
            subheading: "As seen in the data given below WhatsApp usage in India is being driven largely by the young generation.  ",
            lastText: "Regardless of the numbers, we believe that each and every age group is important while we curate the features and implement them, as our motive is to make Elyments accessible for all sorts of users and make their data secure at all times! ",
        }
    ];
    ...
    const data = [
        ...
        { Feature: 'Change of DP  ', Never: 10, Rarely: 5, Sometimes: 5, Often: 20 },
        { Feature: 'Creating group  ', Never: 11, Rarely: 3, Sometimes: 12, Often: 14 },
        { Feature: 'Hiding last seen  ', Never: 24, Rarely: 4, Sometimes: 2, Often: 10 },
        { Feature: 'TeSetting status xt', Never: 21, Rarely: 4, Sometimes: 4, Often: 11 },
        { Feature: 'Broadcast list', Never: 31, Rarely: 0, Sometimes: 2, Often: 7 },
        { Feature: 'Starring messages', Never: 34, Rarely: 3, Sometimes: 1, Often: 2 },
        { Feature: 'Whatsapp Web', Never: 28, Rarely: 4, Sometimes: 4, Often: 4 },
        { Feature: 'Exporting Chats', Never: 37, Rarely: 3, Sometimes: 0, Often: 0 },
        { Feature: 'Whatsapp Payments', Never: 38, Rarely: 2, Sometimes: 0, Often: 0 }
                    ...
                    <div>
                        ...
                        <div className="lg:px-[100px]">
                            ...
                            <div className="text-[20px] text-center sm:text-start mb-20 text-white sm:text-[24px] lg:text-[32px] 2xl:text-[40px] font-semibold">
                                Shortlisting the basic features that are used by diverse users from
                ...
                <Container>
                    ...
                    <div className="lg:pt-[190px] pt-5  flex justify-center relative">
                        <div className="hidden lg:block lg:relative">
                            <img src={ExpandMainBanner} alt="image" className="mx-auto  w-[70%] xl:w-full" />
                            <img src={ExpandLeftFirstAbsolute} alt="image" className="absolute -bottom-[7px] w-[150px] xl:w-auto left-[90px] lg:-left-[111px] xl:-left-[177px]" />
                            <img src={ExpandLeftSecondAbsolute} alt="image" className="absolute bottom-[24%] lg:bottom-[30%] w-[180px] xl:w-auto left-[0] lg:-left-[187px] xl:-left-[277px]" />
                            <img src={ExpandLeftThirdAbsolute} alt="image" className="absolute top-[33%] lg:top-[26%] w-[80px] xl:w-auto left-[210px] lg:left-[56px] xl:-left-[80px]" />
                            <img src={ExpandLeftFourthAbsolute} alt="image" className="absolute top-0 lg:-top-[20%] w-[180px] xl:w-auto md:left-[110px] lg:-left-[30px] xl:-left-[150px]" />
                            <img src={ExpandRightFirstAbsolute} alt="image" className="absolute bottom-[15%] w-[110px] xl:w-auto right-[110px] lg:-right-[140px] xl:-right-[200px]" />
                            <img src={ExpandRightSecondAbsolute} alt="image" className="absolute top-[35%] lg:top-[25%] w-[190px] xl:w-auto right-[140px] lg:-right-[70px] xl:-right-[150px]" />
                            <img src={ExpandRightThirdAbsolute} alt="image" className="absolute top-[9%] lg:-top-[10%] w-[90px] xl:w-auto right-[330px] lg:right-[130px] xl:right-[50px]" />
                        </div>
                        <img src={ExpandMobImg} alt="image" className="inline lg:hidden mx-auto w-full" />
                    </div>
                </Container>
            </section>
                    ...
                    <div className="px-[130px]">
                        ...
                        <div className="grid grid-cols-12 gap-0  items-center lg:py-[100px] ">
                            <div className="col-span-12 lg:col-span-4 lg:order-first">
                                <div className="flex items-center justify-center sm:justify-start relative">
                                    <img src={EnvisioningFirst} alt="image" className="w-[70%] lg:w-[100%] sm:w-auto lg:absolute top-0 bottom-0 m-auto -right-9 " />
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-12 gap-0  items-center lg:py-[100px] ">
                            ...
                            <div className="col-span-12 lg:col-span-4 ">
                                <div className="flex items-center justify-center sm:justify-start relative">
                                    <img src={EnvisioningSecond} alt="image" className="w-[70%] lg:w-[100%] sm:w-auto lg:absolute top-0 bottom-0 m-auto -left-9 " />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-12 gap-0  items-center lg:py-[100px] ">
                            <div className="col-span-12 lg:col-span-4 order-last md:order-first">
                                <div className="flex items-center justify-center sm:justify-start relative">
                                    <img src={EnvisioningThird} alt="image" className="w-[70%] lg:w-[100%] sm:w-auto lg:absolute top-0 bottom-0 m-auto -right-9" />
                                </div>
                            </div>
                            <div className="col-span-1 lg:col-span-2 hidden lg:block">
                                <div className="flex items-center justify-center">
                        ...
                        <div className="grid grid-cols-12 gap-0  items-center lg:py-[100px] ">
                            ...
                            <div className="col-span-12 lg:col-span-4 ">
                                <div className="flex items-center justify-center sm:justify-start relative">
                                    <img src={EnvisioningFourth} alt="image" className="w-[70%] lg:w-[100%] lg:absolute top-0 bottom-0 m-auto -left-9" />
                                </div>
                            </div>
