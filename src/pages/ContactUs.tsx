...
const ContactUS = () => {
    ...
    return (
        <main>
            ...
            {/* ---------- Banner Section ---------- */}
            <div className="contactus-banner pt-[100px]">
                <Container>
                    <div className="contact-from grid grid-cols-12 lg:h-[812px] p-10 md:p-0">
                        <div className="col-span-12 md:col-span-5 flex flex-col justify-center lg:block">
                            <div className=" lg:h-[370px] flex justify-center items-center">
                                <p className='text-[32px] md:text-[60px] text-white font-bold md:p-10 lg:p-20'>
                                    Let’s <span className="animationStroke w-fit h-fit inline-block"><SVGAnimation nameOfClass="svg-container pl-5 contact-us" /> Connect</span>
                                </p>
                            </div>
                            <div className="bg-[#ffffff18] sm:bg-contactus-gradient lg:max-w-[75%] lg:max-h-[410px] lg:h-[100%] md:mr-5 md:ml-5 lg:ml-0 mb-8 sm:mb-0 mt-4 sm:mt-8  rounded-[30px] p-4 xl:p-8 px-6 2xl:px-12">
                                <div className=" border-b border-b-[#818181] border-opacity-25 sm:border-opacity-100 pb-5 mb-5">
                                    <p className='text-2xl lg:text-[28px] text-white sm:text-[#1A1A1A] text-center md:text-start font-semibold mb-2'>
                                        Development Office
                                    </p>
                                    <p className='text-white sm:text-[#4E4E4E] text-opacity-60 sm:text-opacity-100 text-center md:text-start font-medium text-[16px] lg:text-xl'>
                        ...
                        <div className="col-span-12 md:col-span-7">
                            <form action="#" className='sm:py-12 md:pr-12'>
                                <div className="grid grid-cols-12">
                                        ...
                                        <div className="relative mt-3">
                                            <div className="svg-icon absolute top-[50%] right-[25px] -translate-y-[50%]">
                                                <svg width="16" height="23" viewBox="0 0 16 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M11 23H5C2.243 23 0 20.8505 0 18.2083V4.79167C0 2.14954 2.243 0 5 0H11C13.757 0 16 2.14954 16 4.79167V18.2083C16 20.8505 13.757 23 11 23ZM5 1.91667C3.346 1.91667 2 3.20658 2 4.79167V18.2083C2 19.7934 3.346 21.0833 5 21.0833H11C12.654 21.0833 14 19.7934 14 18.2083V4.79167C14 3.20658 12.654 1.91667 11 1.91667H5ZM10 18.2083C10 17.6793 9.552 17.25 9 17.25H7C6.448 17.25 6 17.6793 6 18.2083C6 18.7373 6.448 19.1667 7 19.1667H9C9.552 19.1667 10 18.7373 10 18.2083Z" fill="#393939" />
                                                </svg>
                                            </div>
                                            <input type="text" id='lastName' className='w-full p-4 outline-none rounded-[12px] pr-[60px]' placeholder='Enter your contact number' />
                                        </div>
                                    </div>
                                    <div className="col-span-12 px-2 mb-5">
                                        <label htmlFor="description" className='text-xl font-medium text-white'>
                                            Project Description
                                        </label>
                                        <div className="relative mt-3">
                                            <textarea id='description' rows={5} className='w-full resize-none p-4 outline-none rounded-[12px] pr-[60px]' placeholder='Tell us little about the project '></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-span-12 px-2 mb-5">
                                        ...
                                        <ul className='grid grid-cols-12 justify-between items-center mt-5'>
                                            <li className='relative contactus-checkboxes col-span-12 sm:col-span-6 lg:col-span-4 mb-5'>
                                                <input type="checkbox" id='webdesign' className='hidden' />
                                                ...
                                                <label htmlFor="webdesign" className='text-lg pl-[35px] text-white font-medium block'>
                                                    Website design
                                                </label>
                                            </li>
                                            <li className='relative contactus-checkboxes col-span-12 sm:col-span-6 lg:col-span-4 mb-5'>
                                                <input type="checkbox" id='uxdesign' className='hidden' />
                                                <span className="border-2 inline-block absolute top-[50%]  -translate-y-[50%] pointer-events-none border-[#868686] w-[22px] h-[22px] rounded-[5px]"></span>
                                                <label htmlFor="uxdesign" className='text-lg pl-[35px] text-white font-medium block'>
                                                    UX design
                                                </label>
                                            </li>
                                            <li className='relative contactus-checkboxes col-span-12 sm:col-span-6 lg:col-span-4 mb-5'>
                                                <input type="checkbox" id='userresearch' className='hidden' />
                                                <span className="border-2 inline-block absolute top-[50%]  -translate-y-[50%] pointer-events-none border-[#868686] w-[22px] h-[22px] rounded-[5px]"></span>
                                                <label htmlFor="userresearch" className='text-lg pl-[35px] text-white font-medium block'>
                                                    User research
                                                </label>
                                            </li>
                                            <li className='relative contactus-checkboxes col-span-12 sm:col-span-6 lg:col-span-4 mb-5'>
                                                <input type="checkbox" id='content' className='hidden' />
                                                <span className="border-2 inline-block absolute top-[50%]  -translate-y-[50%] pointer-events-none border-[#868686] w-[22px] h-[22px] rounded-[5px]"></span>
                                                <label htmlFor="content" className='text-lg pl-[35px] text-white font-medium block'>
                                                    Content creation
                                                </label>
                                            </li>
                                            <li className='relative contactus-checkboxes col-span-12 sm:col-span-6 lg:col-span-4 mb-5'>
                                                <input type="checkbox" id='strategy' className='hidden' />
                                                <span className="border-2 inline-block absolute top-[50%]  -translate-y-[50%] pointer-events-none border-[#868686] w-[22px] h-[22px] rounded-[5px]"></span>
                                                <label htmlFor="strategy" className='text-lg pl-[35px] text-white font-medium block'>
                                                    Strategy & Consulting
                                                </label>
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="col-span-12 px-2 pt-4">
                                        <button type='submit' className='bg-contactus-gradient p-4 text-2xl font-semibold sm:max-w-[450px] w-[100%] mx-auto block rounded-full'>
                                            Let’s talk
                                        </button>
                                    </div>
                                </div>
