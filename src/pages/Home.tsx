...
const Home = () => {
  ...
  return (
    <main>
      ...
      <div className="xl:hidden h-[35vh] mt-6 sm:mt-0 sm:h-[70vh] lg:h-screen flex items-center justify-center relative">
        <div className="px-3">
      ...
      <div className="relative z-[100] questionsection">
        ...
        <div className="2xl:my-[100px] xl:my-[80px] mt-10 lg:mt-20">
          <CaseStudyCarousel />
        </div>
