...
const Sustainable = () => {
    ...
    return (
        <main className="custom-sutainable">
                ...
                <Container>
                    <div className="grid grid-cols-12">
                        <div className="col-span-12 xl:col-span-7 ">
                            ...
                            <p className="text-[18px] text-left sm:text-center xl:text-start sm:text-[18px]font-medium text-primary-dark2 mt-4 sm:mt-[40px] xl:mt-8 xl:pe-5 xl:me-5">
                        ...
                        <div className="col-span-12 xl:col-span-7 ">
                            ...
                            <div className="flex justify-center md:justify-start mb-[30px] md:mb-0 gap-5 mt-4 lg:mt-8">
                                ...
                                <div className="list-box mt-5">
                                    <div className="2xl:max-w-[70%] mb-5 border-b-[1px] sm:border-b-[0] border-neutral-300 pb-[22px] sm:pb[0]">
            ...
            <div className="mx-auto mt-9 sm:mt-[100px] lg:mt-[50px] 2xl:mt-[200px] max-w-[1792px] h-auto lg:h-[900px] text-white sus-optimization">
                <Container>
                    ...
                    <div className="grid grid-cols-12">
                        ...
                        <div className="col-span-12 xl:col-span-4">
                            <img
                                src={CalculateSusImg}
                                alt="Image"
                                className="xl:pl-8 max-w-[80%] md:max-w-[40%] lg:max-w-full mx-auto xl:mx-0"
                            />
                        </div>
                    </div>
                </Container>
