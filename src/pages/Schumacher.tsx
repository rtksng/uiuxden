    ...
    <main>
        ...
        <Container>
          <div className="text-center pt-[76px] sm:pt-[90px] lg:pt-[120px] 2xl:pt-[170px] flex flex-col items-center">
            ...
            <h3 className="text-[18px] sm:text-[20px] lg:text-[24px] 2xl:text-[32px] text-primary-dark font-medium sm:w-[70%]">
              <span className="text-primary-dark4">Schumacher Homes'</span>
      ...
      <section className="pHighLightBg relative">
        ...
        <p className="text-lg sm:text-xl lg:text-2xl font-semibold text-center mx-auto max-w-[1350px] pt-[130px] sm:pt-[200px] lg:pt-[426px] pb-[30px] lg:pb-[84px]">
          For over 30 years, Schumacher Homes has perfected a clear and exciting
          process for building homes. They are committed to making the
          experience enjoyable, simple, and hassle-free. Schumacher Homes
          focuses on customer satisfaction, guiding you through each step with
          expertise and care to bring your vision to life.
        </p>
      </section>
            ...
            <div className="col-span-2 lg:col-span-1 self-center">
              <div>
                ...
                <div className="text-[20px] sm:text-[24px] lg:text-[32px] 2xl:text-[40px] font-semibold  mt-1 2xl:mt-4 mb-5 2xl:mb-8 ">
                  Users didn’t fully understand what Schumacher Homes is about
                  due to the lack of information on the main homepage.
                </div>
                <p className="text-base lg:text-lg 2xl:text-xl font-medium text-primary-dark2 w-[90%]">
                  The homepage of the Schumacher Homes website currently
                  features only a hero section with a video. There are no
                  additional sections present on the homepage. This lack of
                  content might limit the user's ability to quickly access other
                  important information or features of the site, potentially
                  impacting the overall user experience. Basically they wanted
                  us to recreate the homepage and process page.
                </p>
              </div>
            </div>
                ...
                <div className="grid grid-cols-12 items-start gap-5  2xl:gap-10 ">
                  <div className="col-span-12 sm:col-span-7 2xl:col-span-6">
                    <p className="text-base lg:text-lg 2xl:text-xl font-medium text-primary-dark2">
                      The client provided us with links to competitor websites,
                      which we used to conduct a comprehensive competitor
                      analysis. Through this analysis, we identified several
                      important sections that are currently missing from our
                      homepage. Based on our findings, we have presented a
                      series of recommendations to the client to enhance the
                  ...
                  <div className="col-span-12 sm:col-span-5 2xl:col-span-6">
                    <p className="text-base lg:text-lg 2xl:text-xl font-medium text-primary-dark2">
                      Our current navigation structure needs to be expanded to
                      include these crucial sections. Additionally, competitors
                      clearly communicated their value propositions on the
                      homepage, something we need to emulate to highlight what
                      sets us apart and the benefits we offer to our users.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-secondary-dark2 rounded-3xl text-base lg:text-lg 2xl:text-xl font-medium  mx-auto text-white">
                <div className="grid grid-cols-4 items-start gap-4 p-[25px] lg:p-[50px]">
                  <div className="col-span-4 lg:col-span-2">
                    <p className="mb-4">
                      Based on our competitor analysis, we created a detailed
                      plan for the homepage, highlighting all key sections and
                      ensuring easy navigation. We sent this plan to the client
                      and, after receiving approval, developed wireframes to
                      visually map out the layout.
                    </p>
                    <p>
                      Next, we designed the user interface (UI), focusing on a
                      modern and attractive look. We
                    </p>
                  </div>
                  <div className="col-span-4 lg:col-span-2">
                    <p className="mb-4">
                      carefully chose colors, fonts, and images to make the
                      homepage engaging and user-friendly.
                    </p>
                    <p className="">
                      The final result is a well-structured, visually appealing
                      homepage that clearly communicates our client's value and
          ...
          <div className="grid grid-cols-2 gap-10 lg:gap-20  items-center justify-content-center pt-[50px] lg:pt-[100px] 2xl:pt-[150px] pb-[100px] sm:pb-[200px] lg:pb-[300px] 2xl:mt-[0px]  border-dashed border-b-2 border-[rgba(255,255,255,0.20)] text-white ">
            <div className="col-span-2 lg:col-span-1 ">
              <div>
                ...
                <div className="text-[20px] sm:text-[24px] lg:text-[32px] 2xl:text-[40px] font-semibold  mt-1 2xl:mt-4 mb-5 2xl:mb-8">
                  Difficulty in Accessing Key Information Due to Overly Complex
                  Navigation.
                </div>
                <p className="text-base lg:text-lg 2xl:text-xl font-medium ">
                  The navigational structure of the Schumacher Homes was found
                  to be overly complicated. Users consistently reported
                  difficulty locating essential pages, most notably the Process
                  page, which is crucial for understanding our building
                  procedures and services. This page contains vital information
                  that helps users navigate the home-building journey, yet it
                  remains buried within a complex and unintuitive menu system.
                </p>
              </div>
            </div>
            <div className="col-span-2 lg:col-span-1">
          ...
          <div className="grid grid-cols-12 sm:gap-10 lg:gap-20  items-center  py-[50px] lg:py-[100px] 2xl:py-[130px]  ">
            ...
            <div className="col-span-12 sm:col-span-8 lg:col-span-6">
              <div className="address-content-wrapper w-100 text-white p-5  sm:py-9 sm:px-9 lg:py-[40px] lg:px-[50px] 2xl:pt-[100px] 2xl:pr-[60px] 2xl:pb-[70px] 2xl:pl-[45px] ">
                ...
                <p className="text-base lg:text-lg 2xl:text-xl font-medium ">
                  After reviewing Schumacher's website navigation and layout, we
                  found it caused significant confusion among users. To tackle
                  this issue, we analyzed real user data research to understand
                  the extent of the problem. Based on what we learned, we
                  provided recommendations to the client and then developed
                  wireframes and UI designs that follow the best practices in
          ...
          <div className="grid grid-cols-2 gap-10 lg:gap-20  items-end pb-[140px]">
            <div className="col-span-2 lg:col-span-1 self-start">
              <div>
                ...
                <p className="text-base lg:text-lg 2xl:text-xl font-medium text-primary-dark2">
                  The client requested a redesign of the Process screen to
                  incorporate more detailed information. The aim was to provide
                  users with a clearer and more comprehensive understanding of
                  the procedures involved. By expanding the content and
                  improving the layout, the redesigned screen will offer a more
                  informative and user-friendly experience, ensuring that all
                  necessary details are easily accessible and clearly presented.
                </p>
              </div>
            </div>
            <div className="col-span-2 lg:col-span-1">
          ...
          <div className="grid grid-cols-12 gap-0 lg:mt-[80px] items-center sm:py-[70px] 2xl:py-[140px]">
            ...
            <div className="col-span-12 sm:col-span-4 lg:col-span-5">
              <div className="flex items-center justify-end">
                <img
                  src={SolutionthreeBanner}
                  alt="image"
                  className="w-[60%] sm:w-auto mx-auto sm:mx-0 pt-5 sm:pt-0"
                />
              </div>
            </div>
            ...
            <div className="col-span-12 sm:col-span-7 lg:col-span-6 ">
              <div className="bg-secondary-dark2 rounded-3xl text-base lg:text-lg 2xl:text-xl font-medium text-primary-dark2 text-white mx-auto mt-5 sm:mt-0">
                <div className="grid grid-cols-4 items-start gap-1 lg:gap-6 p-[25px] lg:p-[50px]">
                  <div className="col-span-4 lg:col-span-2">
                    <p>
                      We conducted a thorough competitor analysis of the Process
                      screen using the websites provided by the client. This
                      analysis allowed us to identify best practices and
                      effective design elements used by competitors. Based on
                      these insights, we formulated detailed recommendations for
                      enhancing the client's Process screen.
                    </p>
                  </div>
                  <div className="col-span-4 lg:col-span-2">
                    <p>
                      After presenting and discussing these recommendations with
                      the client, we moved forward with developing wireframes to
                      map out the improved structure. Finally, we created
                      comprehensive UI designs that incorporated our findings,
                      ensuring a more intuitive and user-friendly experience for
                      visitors.
                    </p>
                  </div>
                </div>
