    ...
    return (
        <main>
            ...
            <div className="relative  h-[45vh] lg:h-[100vh] green-linear ">
                <Container>
                    <div className="text-center pt-[90px] lg:pt-[120px] 2xl:pt-[170px] flex flex-col items-center">
                        <img src={paulSchumacherDark} alt="schumacherlogo" width={250} className="mx-auto" />
                        <h1 className="text-[48px] lg:text-[66px]  2xl:text-[90px] text-black  font-semibold mb-base">
                            Building Dream Homes
                        </h1>
                        <h3 className="text-[20px] lg:text-[24px] 2xl:text-[32px] text-primary-dark font-medium w-[70%]">
                    ...
                    <div className="absolute bottom-5 left-2  2xl:left-9 ">
                        <div className="xl:flex xl:items-center">
                            <img src={rightLongArrow} alt="arrow" width={50} className="xl:mx-auto" />
                            <div className="xl:ml-3">
                                <h6 className="text-[16px] xl:text-[18px] text-black font-normal">
                                    Home | Casestudy
                                </h6>
                                <h6 className="text-[16px] xl:text-[18px] text-black font-normal">
                                    Schumacher Homes
            ...
            <section className="pHighLightBg relative">
                <img
                    ...
                    alt="KD Graphic"
                    className="absolute inset-0 -top-[160px] lg:-top-[220px] 2xl:-top-[280px] max-w-[500px] lg:max-w-[900px] 2xl:max-w-[1034px] mx-auto"
                />
                <p className="text-xl lg:text-2xl font-semibold text-center mx-auto max-w-[1350px] pt-[200px] lg:pt-[426px] pb-[30px] lg:pb-[84px]">
            ...
            <section className="py-[100px] 2xl:py-[150px]">
                ...
                <Container>
                    <h3 className="lg:text-center text-[42px] lg:text-[50px] 2xl:text-[60px] font-semibold">
                    ...
                    <div className="grid grid-cols-2 gap-10 lg:gap-20 mt-[30px] lg:mt-[70px]">
                        <div className="col-span-2 lg:col-span-1 self-center">
                            <div>
                                ...
                                <div className="text-[24px] lg:text-[32px] 2xl:text-[40px] font-semibold  mt-1 2xl:mt-4 mb-5 2xl:mb-8 ">
                    ...
                    <div className="grid grid-cols-2 gap-10 lg:gap-20  items-end pb-[140px]">
                        ...
                        <div className="col-span-2 lg:col-span-1">
                            <div className="relative">
                                ...
                                <img src={SolutionTwo} alt="image" className="absolute top-[80%]  2xl:top-[80%]  right-[10px]  lg:right-[50%] 2xl:right-[87%]" />
                            </div>
                        </div>
                    </div>
            ...
            <section className="problem2-section">
                <Container>
                    <div className="grid grid-cols-2 gap-10 lg:gap-20  items-center justify-content-center pt-[50px] lg:pt-[100px] 2xl:pt-[150px] pb-[200px] lg:pb-[300px] 2xl:mt-[0px]  border-dashed border-b-2 border-[rgba(255,255,255,0.20)] text-white ">
                        <div className="col-span-2 lg:col-span-1 ">
                            <div>
                                <div className="text-[18px] font-semibold text-secondary-light2">
                                    PROBLEM 2
                    ...
                    <div className="grid grid-cols-12 gap-10 lg:gap-20  items-center  py-[50px] lg:py-[100px] 2xl:py-[130px]  ">
                        <div className="col-span-1 hidden lg:block"></div>

                        <div className="col-span-8 lg:col-span-6">
                            <div className="address-content-wrapper w-100 text-white py-9 px-9 lg:py-[40px] lg:px-[50px] 2xl:pt-[100px] 2xl:pr-[60px] 2xl:pb-[70px] 2xl:pl-[45px] ">
                                <div className="text-[24px] lg:text-[32px] 2xl:text-[40px] font-semibold  mt-1 2xl:mt-4 mb-5 2xl:mb-8">
            ...
            <section className=" pt-[50px] lg:pt-[140px]">
                <Container>
                    ...
                    <div className="grid grid-cols-12 gap-0 lg:mt-[80px] items-center py-[70px] 2xl:py-[140px]">
                        <div className="col-span-12">
                            <div className="text-[24px] lg:text-[32px] 2xl:text-[40px] font-semibold mt-4 mb-9 lg:mb-[90px] text-center">
