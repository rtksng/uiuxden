        ...
        <main>
            ...
            <section className="relative pt-12 ">
                <div className="blog-detail-header mt-6">
                    <Container>
                        <div className="pt-[80px] sm:pt-[100px] xl:pt-[90px] flex flex-col items-center">
                    ...
                    <div>
                        <div className="grid grid-cols-12 gap-[50px]">
                            <div className="col-span-12 xl:col-span-8">
                                ...
                                <div className="my-11 border-b-[1px] border-[#CDCDCDAD] pb-20 pl-8">
                                    <div>
                                        <h3 className="text-[40px] text-primary-dark2 font-semibold mb-8">
                                            Introduction
                                        </h3>
                                        <p className="text-[20px] text-primary-dark2 font-normal mb-12">
                                ...
                                <div className="bg-[#F3F6F8AD] rounded-[18px] p-8 xl:p-[60px]">
                                ...
                                <div>
                                    <div className="flex  items-center gap-4 mt-[100px] mb-7">
                                    ...
                                    <div className="bg-[#F3F6F8AD] rounded-[18px] p-8 xl:p-[60px]">
                                        <div className="grid grid-cols-12 gap-[50px]">
                                            <div className="col-span-12 xl:col-span-6">
                                                <div>
                                                    <label className="text-[20px] font-medium text-primary-dark2     ">
                                                        First Name
                                                    </label>
                                                    <div className="flex items-center bg-white px-4 outline-1 -outline-offset-1 border border-[#CBCBCB] has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-600  rounded-[12px] mt-2">
                                                        <input
                                                            ...
                                                            className="block min-w-0 grow py-4 text-base text-gray-900 placeholder:text-secondary-dark focus:outline-none sm:text-[18px]"
                                                        />
                                            ...
                                            <div className="col-span-12 xl:col-span-12">
                                                <div>
                                                    ...
                                                    <textarea
                                                        ...
                                                        name="price"
                                                        rows={5}
                                                        className="block min-w-0 grow py-4 text-base text-gray-900 placeholder:text-secondary-dark focus:outline-none sm:text-[18px] border border-[#CBCBCB] rounded-[12px] px-4 w-full mt-2"
                                                    />
                                                </div>
                                    ...
                                    <div className="xl:h-full blog-detail-related-card-bg p-4">
                                        <div className="grid grid-cols-12 gap-7  ">
                                            ...
                                            <div className="col-span-12 xl:col-span-7">
                                                ...
                                                <h4 className="text-[18px] font-semibold text-primary-dark2 line-clamp-2 mt-3 mb-5">
