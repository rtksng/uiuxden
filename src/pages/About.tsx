...
const About = () => {
  ...
  return (
    <main className="aboutPage">
      <Navbar />
      <section className="flex justify-center items-center h-[50vh] lg:h-[75vh] xl:h-screen pt-[100px]">
        <Container>
          <div className="grid grid-cols-12">
            ...
            <div className="md:col-span-4 col-span-10 self-center mt-8">
      ...
      <div className="mx-auto mt-9 sm:mt-[100px] lg:mt-[200px] max-w-[1792px] h-auto lg:h-[800px] text-white commitment">
        <Container>
