...
const Button: React.FC<ButtonProps> = ({
  ...
  const primaryStyles =
    "bg-neutral-800 text-white hover:bg-transparent border-2 border-transparent hover:text-primary-dark hover:border-primary-dark  focus:ring-2 focus:ring-primary-dark";
