...
const Button: React.FC<ButtonProps> = ({
  ...
  const primaryStyles =
    "bg-primary-dark text-white hover:bg-white border-2 border-transparent hover:text-primary-dark hover:border-primary-dark  focus:ring-2 focus:ring-primary-dark";
