...
const Tabs: React.FC<TabsProps> = ({ tabs, autoSwitchInterval = 3000 }) => {
    ...
    return (
        <div className="flex flex-col md:flex-row justify-center py-[60px] lg:py-[140px]">
            <div className="relative min-w-[50%] gap-[40px] flex flex-col md:items-end items-center before:w-[100%] md:before:w-[1px] before:bg-white md:before:h-[100%] before:h-[1px] before:absolute md:before:right-0 before:bottom-0 pb-12 md:pb-0 md:pe-[70px]">
                {tabs.map((tab, index) => (
                    <button
                        className={
